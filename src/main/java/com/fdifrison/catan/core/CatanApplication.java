    ...
    CommandLineRunner commandLineRunner(
        ...
        return args -> {
            ...
            var p1 = new PlayerDTO(
                    1, "Giova", "ing.giovanni.frison@gmail.com", "https://i.imgur.com/jt0Uubi.png", false);
            var p2 = new PlayerDTO(2, "Mich", "michele.roberti7@gmail.com", "https://i.imgur.com/GdNzR8P.png", false);
            var p3 = new PlayerDTO(3, "Pisco", "l.piscagli92@gmail.com", "https://i.imgur.com/vnNKlTi.png", false);
            var p4 =
                    new PlayerDTO(4, "Berna", "luca.bernabini1989@gmail.com", "https://i.imgur.com/vy3NMkP.png", false);
            var p5 = new PlayerDTO(5, "Cata", "luca.catalani1@gmail.com", "https://i.imgur.com/Ejm5crd.png", false);
            var p6 = new PlayerDTO(6, "Jolly", "jolly@email.com", "https://i.imgur.com/Q0woEmX.png", false);
            try {
                ...
                var gameId = gameService.createGame(new GameSetupDTO(
                        ...
                        java.util.List.of(po1, po2, po3, po4, po5)));
                ...
                for (int i = 0; i < 10; i++) {
                    ...
                    for (Long p : java.util.List.of(p1Id, p2Id, p3Id, p4Id, p5Id)) {
