...
public record GameSetupDTO(@NotNull GameSetupDTO.SetupDTO gameInfo, List<GamePlayerInfoDTO> playersInfo) {

    @Schema(description = "Basic info about the game")
    public record SetupDTO(
            @NotNull String gameName, @NotNull Game.GameType gameType, int requiredVictoryPoints) {}
